    ...
    switch (config.db.default.type) {
      case DbType.POSTGRES:
        await queryRunner.query(
          `CREATE TABLE IF NOT EXISTS "locale" ("code" character varying(255) NOT NULL, "language" character varying(255) NOT NULL, "region" character varying(255) NOT NULL, "date_created" TIMESTAMP NOT NULL DEFAULT now(), "date_modified" TIMESTAMP NOT NULL DEFAULT now(), PRIMARY KEY ("code"))`,
        );
        await queryRunner.query(`
        INSERT INTO "locale" (code, language, region)
        VALUES
          ('af', 'Afrikaans', ' '),

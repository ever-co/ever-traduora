...
export class projectClientsTable1549981241264 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('DROP TABLE `project_client`');
  }
}
